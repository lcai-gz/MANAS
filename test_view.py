...
parser.add_argument('--ckt_path', type=str, default='eval-EXP-step2-half-64-batch32-lamda_comp=0.1-lamda_arch=0.01-ssim-20220410-004752/last_weights.pt', help='checkpoint path of model')
